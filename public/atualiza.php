        ...
        <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-2xl flex">
            <div class="w-[70%] pr-8">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <button type="button" onclick="window.location.href='/public/config/deleta_conta.php'" class="bg-red-500 text-white px-4 py-2 rounded-lg hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-opacity-50">Excluir conta</button>
                </div>
                <?php if (!$login) : ?>
