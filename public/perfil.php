        ...
        <div class="bg-white rounded-lg shadow-lg p-8 flex h-[90%]">
            <div class="w-2/5 pr-8 h-full flex flex-col items-center mt-8">
                    ...
                    <?php else : ?>
                        ...
                        <button class="bg-gray-500 text-white px-4 py-2 rounded-lg hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-opacity-50" onclick="window.location.href='/public/cadastro.php?form=atualiza'">Editar Perfil</button>
                    <?php endif ?>
            </div>
