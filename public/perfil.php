        ...
        <div class="bg-white rounded-lg shadow-lg p-8 flex h-[90%]">
            <div class="w-2/5 pr-8 h-full">
                <div class="flex flex-col items-center">
                    ...
                    <button class="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 mb-4">Criar Nova Postagem</button>
