    ...
    <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-sm">
        ...
        <form>
            ...
            <div class="flex items-center justify-between mb-6">
                <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">Logar</button>
                <a href="#" class="text-blue-500 hover:underline">Cadastro</a>
            </div>
        </form>
    </div>
</body>
